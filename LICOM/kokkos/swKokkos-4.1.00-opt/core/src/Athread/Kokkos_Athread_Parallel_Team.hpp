...
#ifndef KOKKO_ATHREAD_PARALLEL_TEAM_HPP
#define KOKKO_ATHREAD_PARALLEL_TEAM_HPP
...
/*
 * < Kokkos::Athread , WorkArgTag >
 * < WorkArgTag , Impl::enable_if< std::is_same< Kokkos::Athread ,
 * Kokkos::DefaultExecutionSpace >::value >::type >
 *
 */
template <class... Properties>
class TeamPolicyInternal<Kokkos::Athread, Properties...>
 ...
 public:
  ...
  using execution_space = Kokkos::Athread;
  ...
  TeamPolicyInternal(
      const TeamPolicyInternal<Kokkos::Athread, OtherProperties...>& p) {
  ...
  using member_type = Impl::HostThreadTeamMember<Kokkos::Athread>;
};
...
class ParallelFor<FunctorType, Kokkos::TeamPolicy<Properties...>,
 ...
 private:
  ...
  using Policy = TeamPolicyInternal<Kokkos::Athread, Properties...>;
...
class ParallelReduce<CombinedFunctorReducerType,
                     Kokkos::TeamPolicy<Properties...>, Kokkos::Athread> {
 private:
 ...
 public:
  ...
  ParallelReduce(const CombinedFunctorReducerType& arg_functor_reducer,
    ...
    static_assert(Kokkos::is_view<ViewType>::value,
                  "Reduction result on Kokkos::Athread must be a Kokkos::View");
