...
extern "C" void kokkos_athread_parallel_for_launch (struct AthreadParamWrap*);
extern "C" void kokkos_athread_parallel_reduce_launch (struct AthreadParamWrap*);

// extern "C" void athread_parallel_for_launch_1D (struct AthreadParamWrap1D*);
