...
#if (710 > KOKKOS_COMPILER_GNU)
#error "Compiling with GCC version earlier than 7.1.0 is not supported."
...
// There is zero or one default execution space specified.
         ...
         (defined(KOKKOS_ENABLE_DEFAULT_DEVICE_TYPE_ATHREAD) ? 1 : 0) +      \
...
#elif defined(KOKKOS_ENABLE_DEFAULT_DEVICE_TYPE_ATHREAD)
...
#define KOKKOS_ENABLE_DEFAULT_DEVICE_TYPE_ATHREAD
#else
...
// wjl 20231026
#elif !defined(KOKKOS_ENABLE_HIP) && !defined(KOKKOS_ENABLE_SYCL) && !defined(KOKKOS_ENABLE_ATHREAD)
#define KOKKOS_ENABLE_TASKDAG
#endif
...
#define KOKKOS_REGISTER_FOR_1D(FUNC_NAME, ...) KOKKOS_ATHREAD_REGISTER_FOR_1D(FUNC_NAME, __VA_ARGS__)
#define KOKKOS_REGISTER_FOR_2D(FUNC_NAME, ...) KOKKOS_ATHREAD_REGISTER_FOR_2D(FUNC_NAME, __VA_ARGS__)
#define KOKKOS_REGISTER_FOR_3D(FUNC_NAME, ...) KOKKOS_ATHREAD_REGISTER_FOR_3D(FUNC_NAME, __VA_ARGS__)
#define KOKKOS_REGISTER_FOR_4D(FUNC_NAME, ...) KOKKOS_ATHREAD_REGISTER_FOR_4D(FUNC_NAME, __VA_ARGS__)
#define KOKKOS_REGISTER_FOR_5D(FUNC_NAME, ...) KOKKOS_ATHREAD_REGISTER_FOR_5D(FUNC_NAME, __VA_ARGS__)
#define KOKKOS_REGISTER_FOR_6D(FUNC_NAME, ...) KOKKOS_ATHREAD_REGISTER_FOR_6D(FUNC_NAME, __VA_ARGS__)

#define KOKKOS_REGISTER_REDUCE_1D(FUNC_NAME, ...) KOKKOS_ATHREAD_REGISTER_REDUCE_1D(FUNC_NAME, __VA_ARGS__)
#define KOKKOS_REGISTER_REDUCE_2D(FUNC_NAME, ...) KOKKOS_ATHREAD_REGISTER_REDUCE_2D(FUNC_NAME, __VA_ARGS__)
#define KOKKOS_REGISTER_REDUCE_3D(FUNC_NAME, ...) KOKKOS_ATHREAD_REGISTER_REDUCE_3D(FUNC_NAME, __VA_ARGS__)
#define KOKKOS_REGISTER_REDUCE_4D(FUNC_NAME, ...) KOKKOS_ATHREAD_REGISTER_REDUCE_4D(FUNC_NAME, __VA_ARGS__)
#define KOKKOS_REGISTER_REDUCE_5D(FUNC_NAME, ...) KOKKOS_ATHREAD_REGISTER_REDUCE_5D(FUNC_NAME, __VA_ARGS__)
#define KOKKOS_REGISTER_REDUCE_6D(FUNC_NAME, ...) KOKKOS_ATHREAD_REGISTER_REDUCE_6D(FUNC_NAME, __VA_ARGS__)
#else // KOKKOS_ENABLE_ATHREAD
#define KOKKOS_REGISTER_FOR_1D(FUNC_NAME, ...)
#define KOKKOS_REGISTER_FOR_2D(FUNC_NAME, ...)
#define KOKKOS_REGISTER_FOR_3D(FUNC_NAME, ...)
#define KOKKOS_REGISTER_FOR_4D(FUNC_NAME, ...)
#define KOKKOS_REGISTER_FOR_5D(FUNC_NAME, ...)
#define KOKKOS_REGISTER_FOR_6D(FUNC_NAME, ...)

#define KOKKOS_REGISTER_REDUCE_1D(FUNC_NAME, ...)
#define KOKKOS_REGISTER_REDUCE_2D(FUNC_NAME, ...)
#define KOKKOS_REGISTER_REDUCE_3D(FUNC_NAME, ...)
#define KOKKOS_REGISTER_REDUCE_4D(FUNC_NAME, ...)
#define KOKKOS_REGISTER_REDUCE_5D(FUNC_NAME, ...)
#define KOKKOS_REGISTER_REDUCE_6D(FUNC_NAME, ...)
#endif // KOKKOS_ENABLE_ATHREAD
