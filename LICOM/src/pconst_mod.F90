...
! wjl 20240127
      real(r8),dimension(:,:),allocatable::s_lon,s_lat
!lhl090729
...
!lhl1204
      ...
      ! wjl 20240225
      real(r8),dimension(imt,jmt,km,max_blocks_clinic)::am3
!lhl
      ! wjl 20240225
...
!lhl20130419
      ...
      logical:: simple_assm !using the simple assimilation(restoring) or not 
       ...
       real(r8),dimension(imt,jmt,km,max_blocks_clinic) :: fz_tide,ak_tide
