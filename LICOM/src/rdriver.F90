...
!===============================================
      ...
      !                     field_loc_center, field_type_scalar)
      call scatter_global_group_dbl(sss3(:,:,k,:), buffer, numTaskPerGroup, distrb_clinic, &
                          field_loc_center, field_type_scalar)
      !sss3(:,:,k,:)=vars_r4(:,:,:)*1.0D0
      !sss3(:,:,k,:)=vars_r4(:,:,:)*1.0D0
      sss3(:,:,k,:)=sss3(:,:,k,:)*VIT(:,:,1,:)
...
!                           field_loc_center, field_type_scalar)
    call scatter_global_group_dbl(wave_dis(:,:,:), buffer, numTaskPerGroup, distrb_clinic, &
                          field_loc_center, field_type_scalar)
...
!                           field_loc_center, field_type_scalar)
    call scatter_global_group_dbl(chloro3(:,:,k,:), buffer, numTaskPerGroup, distrb_clinic, &
                          field_loc_center, field_type_scalar)
