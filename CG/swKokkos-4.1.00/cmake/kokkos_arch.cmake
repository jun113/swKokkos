...
DECLARE_AND_CHECK_HOST_ARCH(SW26010PRO        "SW26010 Pro")
...
#------------------------------- KOKKOS_ATHREAD_OPTIONS ---------------------------
#clear anything that might be in the cache
GLOBAL_SET(KOKKOS_ATHREAD_HOST_OPTIONS)
GLOBAL_SET(KOKKOS_ATHREAD_DEVICE_OPTIONS)
# host: -mhost
# device: -mslave
# link: -mhybrid -static
IF (KOKKOS_ENABLE_ATHREAD)
  # COMPILER_SPECIFIC_LINK_OPTIONS(
  #   DEFAULT -mhybrid -static
  # )
  # COMPILER_SPECIFIC_LINK_OPTIONS(
  #   DEFAULT -mdynamic
  # )
  # GLOBAL_APPEND(KOKKOS_ATHREAD_HOST_OPTIONS -mhost)
  # GLOBAL_APPEND(KOKKOS_ATHREAD_DEVICE_OPTIONS -mslave)
ENDIF()
...
FOREACH (_BACKEND OpenMP Threads HPX Athread)
  STRING(TOUPPER ${_BACKEND} UC_BACKEND)
  IF(KOKKOS_ENABLE_${UC_BACKEND})
    IF(_HOST_PARALLEL)
    ...
    # ELSEIF(${_BACKEND} STREQUAL "Athread")
    #    SET(_HOST_PARALLEL "Kokkos::Experimental::${_BACKEND}")
    ELSE()
