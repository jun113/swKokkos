...
#ifndef KOKKOS_ATHREAD_UNIQUE_TOKEN_HPP
#define KOKKOS_ATHREAD_UNIQUE_TOKEN_HPP
...
template <>
class UniqueToken<Athread, UniqueTokenScope::Instance> {
 public:
...
template <>
class UniqueToken<Athread, UniqueTokenScope::Global> {
 public:
  using execution_space = Athread;
  using size_type       = int;
