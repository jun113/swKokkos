...
IF(Kokkos_ENABLE_ATHREAD)
  ...
  STRING(FIND ${INTERNAL_COMPILER_VERSION_ONE_LINE} "sw" INTERNAL_COMPILER_VERSION_CONTAINS_SW)
  # IF(INTERNAL_COMPILER_VERSION_CONTAINS_SW GREATER -1)
  #   SET(KOKKOS_CXX_COMPILER_ID SWGCC CACHE STRING INTERNAL FORCE)
  # ENDIF()
  SET(KOKKOS_CXX_COMPILER_ID SWGCC CACHE STRING INTERNAL FORCE)

  STRING(REGEX MATCH "[0-9]+\\.[0-9]+\\.[0-9]+ [0-9]+"
         TEMP_CXX_COMPILER_VERSION ${INTERNAL_COMPILER_VERSION_ONE_LINE})
  # STRING(REGEX MATCH "swgcc-[0-9]+"
  #        TEMP_CXX_COMPILER_VERSION ${INTERNAL_COMPILER_VERSION_ONE_LINE})
  # STRING(REGEX MATCH "[0-9]+"
  #        TEMP_CXX_COMPILER_VERSION ${TEMP_CXX_COMPILER_VERSION})
  SET(KOKKOS_CXX_COMPILER_VERSION ${TEMP_CXX_COMPILER_VERSION} CACHE STRING INTERNAL FORCE)
  MESSAGE(STATUS "Compiler Version: ${KOKKOS_CXX_COMPILER_VERSION}")
ENDIF()
...
ELSEIF(KOKKOS_CXX_COMPILER_ID STREQUAL GNU)
  ...
  IF(KOKKOS_CXX_COMPILER_VERSION VERSION_LESS 7.1.0)
    MESSAGE(FATAL_ERROR "${KOKKOS_MESSAGE_TEXT}")
  ENDIF()
