...
IF (NOT KOKKOS_CXX_STANDARD_FEATURE)
  ...
  ELSEIF(KOKKOS_CXX_COMPILER_ID STREQUAL SWGCC)
    INCLUDE(${KOKKOS_SRC_PATH}/cmake/sw.cmake)
    kokkos_set_sw_flags(${KOKKOS_CXX_STANDARD} ${KOKKOS_CXX_INTERMEDIATE_STANDARD})
